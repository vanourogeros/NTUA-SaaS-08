...
app.get('/api/diagrams/:userID', async (req, res) => {
    ...
    // TODOne: Fetch diagrams for the user from all other microservices
    ...
    const services = ['http://store-line-basic:3020', 'http://store-basic-column:3021',
        ...
        ,'http://store-network-graph:3025', 'http://store-polar-chart:3026',
        'http://store-word-cloud:3027', 'http://store-organization-chart:3028'];
    try {
